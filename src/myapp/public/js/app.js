...
var render = function() {
  ...
  return _c(
    ...
    { staticClass: "navbar" },
    [
      _c("Router-link", { staticClass: "navbat__brand", attrs: { to: "/" } }, [
        _vm._v("\n        Vue\n    ")
      ]),
      _vm._v(" "),
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return _store_index__WEBPACK_IMPORTED_MODULE_3__["default"].dispatch('auth/currentUser');
...
window.axios.defaults.headers.common['X-Reqquest-With'] = 'XMLHttpRequest';
